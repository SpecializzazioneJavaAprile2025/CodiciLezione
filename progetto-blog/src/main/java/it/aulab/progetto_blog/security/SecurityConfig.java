...
@Configuration
//Grazie a questa annotation Spring Security si aspetta che qui ci saranno le istruzioni necessarie
@EnableWebSecurity
public class SecurityConfig {
    ...
    //Vengono creati utenti solo nella memoria ram, questo vuol dire che quando spegneremo l'applicazione tutto sparirà
    //utile solo per fasi di test e prototipazione
    @Bean
